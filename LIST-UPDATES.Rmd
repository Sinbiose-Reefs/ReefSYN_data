...
2) Is it possible to define a scale that integrates all data sets? From now, each data set has an unique hierarchy which might hardly match with other data sets.
