...
trend_benthos_annotate <- trend_benthos + geom_text(data = begin_data, aes (x= min_year, y = 2000,
  ...
  ggplot2::annotate("text", x = 2020, y = 600, label = "ReefSYN")+
  ggplot2::annotate("text", x = 2015, y = 400, label = "PELD-ILOC")+
  ggplot2::annotate("text", x = 2011, y = 200, label = "SISBIOTAMar")
...
trend_fish_annotate <- trend_fish + geom_text_repel(data = begin_data_fish, aes (x= min_year, y = 12000,
  ...
  ggplot2::annotate("text", x = 2020, y = 2400, label = "ReefSYN")+
  ggplot2::annotate("text", x = 2015, y = 1700, label = "PELD-ILOC")+
...
trend_benthos_SR <- ggplot (data = acc_time, 
  ...
  ggplot2::annotate("text", x = 2020, y = 25, label = "ReefSYN")+
  ggplot2::annotate("text", x = 2015, y = 18, label = "PELD-ILOC")+
  ggplot2::annotate("text", x = 2011, y = 10, label = "SISBIOTAMar")
...
trend_fish_SR <- ggplot (data = acc_time_fish, aes (x=year, y=SR)) + 
  ...
  geom_segment(aes(x = 2020, y = 35, xend = 2022, yend = 35),size=3,col="#5A8F7B")+
  ggplot2::annotate("text", x = 2020, y = 70, label = "ReefSYN")+
  ggplot2::annotate("text", x = 2015, y = 45, label = "PELD-ILOC")+
  ggplot2::annotate("text", x = 2011, y = 18, label = "SISBIOTAMar")
