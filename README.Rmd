...
wm <- ggplot() + 
  ...
  labs (title = "Institutions of ReefSYN researchers")
...
list_benthos <- list(data.frame (ds1, Dataset= "X"),
                     data.frame (ds4, Dataset = "IX"),
                     data.frame (ds3, Dataset ="XI"),
                     data.frame (ds2, Dataset="XII"),
                     data.frame (ds5, Dataset = "VIII"))
...
# panel of maps
gridExtra::grid.arrange(# why you suggested patchwork and wm_data + wm_data_fish?
             wm_data_fish,
             wm_data,
             ncol=2)
...
list_occ_benthos <- list(data.frame (ds1_occ, Dataset= "X"),
                     data.frame (ds4_occ, Dataset = "IX"),
                     data.frame (ds3_occ, Dataset ="XI"),
                     data.frame (ds2_occ, Dataset="XII"),
                     data.frame (ds5_occ, Dataset = "VIII")
)
...
list_occ_fish <- list(data.frame (ds11_occ, Dataset = "I"),    
                  ...
                  data.frame (ds6_occ, Dataset = "VII"),
